...
<h2>MP Movie House - Add</h2>

<h3>To add movies to your inventory, Click the link below:</h3>

<form>
         <input type="button" onclick="window.location.href = 'https://github.com/JamesMcKinley-Portee/MP-Movie_House/Add" value="Add a Movie"/>
</form>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  $sql = "INSERT INTO movies (movietitle, releaseyear, director, actor, genre) VALUES ($movietitle, $releaseyear, $director, $actor, $genre)";
  
  if(!mysqli_query($conn, $sql))
  {
      echo "Values not inserted into inventory";
  }
  else
  {
      echo "Values inserted into inventory";
  }
  
  header("refresh: 2; url=Add.php ");
  
echo "<h2>Add a Movie Confirmation:</h2>";
echo $movietitle;
echo "<br>";
echo $releaseyear;
echo "<br>";
