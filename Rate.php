...
<h2>MP Movie House - Rate</h2>

<h3>To rate a movie in your inventory, Click the link below:</h3>

<form>
         <input type="button" onclick="window.location.href = 'https://github.com/JamesMcKinley-Portee/MP-Movie_House/Rate" value="Rate a Movie"/>
</form>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <?php
echo "<h2>Rate a Movie Confirmation:</h2>";
echo $movietitle;
echo "<br>";
echo $releaseyear;
echo "<br>";
